...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a
			href="${ctx}/gen/genTemplate/form?id=${genTemplate.id}">代码模板<shiro:hasPermission
					name="gen:genTemplate:edit">${not empty genTemplate.id?'修改':'添加'}</shiro:hasPermission>
				<shiro:lacksPermission name="gen:genTemplate:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="genTemplate"
		action="${ctx}/gen/genTemplate/save" method="post"
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<form:checkboxes items="${fns:getDictList('gen_category')}"
					path="categoryList" itemLabel="label" itemValue="value"
					htmlEscape="false" />
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="filePath" htmlEscape="false" maxlength="500"
					class="required input-xxlarge" />
				<br /> <span class="help-inline"> 示例如下：<br />
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="fileName" htmlEscape="false" maxlength="500"
					class="required input-xlarge" />
				<br /> <span class="help-inline"> 示例如下：<br />
					java：\${ClassName}Entity.jsp<br /> view：\${className}List.jsp
				</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea id="content" htmlEscape="true" path="content"
					rows="25" class="required" style="width:90%;" wrap="off" />
				<script type="text/javascript">
