	...
	<form:form id="inputForm" modelAttribute="article"
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:ckfinder input="image" type="thumb" uploadPath="/cms/article"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="articleData.copyfrom" htmlEscape="false"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:checkboxes path="posidList"
					items="${fns:getDictList('cms_posid')}" itemLabel="label"
					itemValue="value" htmlEscape="false" />
			</div>
		</div>
		<div class="control-group">
