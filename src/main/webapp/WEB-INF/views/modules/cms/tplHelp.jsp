		...
		<div class="row">
			<div class="span12">
				<section id="download-bootstrap">
					...
					<p class="lead">
						下载之前先检查一下是否准备好了一个代码编辑器(我们推荐使用 <a href="http://sublimetext.com/2">Sublime
							Text 2</a>)
					...
					<div class="row-fluid">
						<div class="span6">
							<h2>下载编译好的文件</h2>
							<p>
								<strong>快速开始:</strong>立即下载编译好的版本吧，里面已经包含了CSS、JS和图片文件了，而且所有文件已经经过了压缩处理。不过，文档和源码文件不包含哦。
							</p>
							<p>
								<a class="btn btn-large btn-primary" href="assets/bootstrap.zip">下载Bootstrap</a>
							</p>
						</div>
						<div class="span6">
							<h2>下载源码</h2>
							...
							<p>
								<a class="btn btn-large"
									href="https://github.com/twitter/bootstrap/zipball/master">下载Bootstrap源码</a>
							</p>
						</div>
					</div>
				</section>
