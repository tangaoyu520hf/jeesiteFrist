...
<link href="${ctxStaticTheme}/wz/css/wz.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<div id="ui-header_xiao">
		<div class="ui-btn-left"
			onclick="dourl('${ctx}/index-${site.id}${fns:getUrlSuffix()}')"></div>
				...
				<c:if test="${category.module eq 'article'}">
					<c:forEach items="${page.list}" var="article">
						<li class="only1_xiao" onclick="dourl('${article.url}')">
							...
							<div class="img">
								<img style="width: 72px; height: auto; max-height: 55px;"
									src="${article.image}">
							</div>
							<p class="onlyheight_60">${article.description}
