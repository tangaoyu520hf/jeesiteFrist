...
<body>
	...
	<form:form id="inputForm" modelAttribute="category"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="showModes"
					items="${fns:getDictList('cms_show_modes')}" itemLabel="label"
					itemValue="value" htmlEscape="false" class="required" />
				<%--
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="allowComment"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="isAudit"
					items="${fns:getDictList('yes_no')}" itemLabel="label"
					itemValue="value" htmlEscape="false" />
			</div>
		</div>
