...
body {
	background: url(${ctxStatic}/images/login_bg.jpg) no-repeat center
		center;
}
</style>
...
<body>
	...
	<form id="loginForm" class="form-signin" action="${ctx}/login"
		...
		<label for="rememberMe" title="下次不需要再登录" style="color: #fff"><input
			type="checkbox" id="rememberMe" name="rememberMe"
			${rememberMe ? 'checked' : ''} /> 记住我（公共场所慎用）</label>
		<div id="themeSwitch" class="dropdown">
			<a class="dropdown-toggle" data-toggle="dropdown" href="#"
				style="color: #fff">${fns:getDictLabel(cookie.theme.value,'theme','默认主题')}<b
				class="caret"></b></a>
