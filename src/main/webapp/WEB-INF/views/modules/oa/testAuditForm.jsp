...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a
			href="${ctx}/oa/testAudit/form?id=${testAudit.id}"><shiro:hasPermission
					name="oa:testAudit:edit">审批${not empty testAudit.id?'修改':'申请'}流程</shiro:hasPermission>
			...
			<table class="table-form">
				<tr>
					...
					<td><sys:treeselect id="user" name="user.id"
							...
							labelValue="${testAudit.user.name}" title="用户"
							url="/sys/office/treeData?type=3" cssClass="required recipient"
					...
					<td><form:input path="post" htmlEscape="false" maxlength="50" />
					</td>
				</tr>
				<tr>
					<td class="tit">调整原因</td>
					<td colspan="5"><form:textarea path="content" class="required"
				...
				<tr>
					<td class="tit">月增资</td>
					<td colspan="2"><form:input path="addNum" htmlEscape="false"
							maxlength="50" /></td>
					<td class="tit">执行时间</td>
					<td colspan="2"><form:input path="exeDate" htmlEscape="false"
							maxlength="50" /></td>
				</tr>
				<tr>
		...
		<div class="form-actions">
			<shiro:hasPermission name="oa:testAudit:edit">
				<input id="btnSubmit" class="btn btn-primary" type="submit"
					value="提交申请" onclick="$('#flag').val('yes')" />&nbsp;
