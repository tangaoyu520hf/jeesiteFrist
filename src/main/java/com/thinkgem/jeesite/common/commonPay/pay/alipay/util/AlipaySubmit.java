...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
		...
		if (AlipayConfig.sign_type.equals("MD5")) {
			...
			mysign = MD5.sign(prestr, sPara.get(AlipayConstant.KEY),
					AlipayConfig.input_charset);
		}
		return mysign;
	}
	...
	public static String buildRequest(Map<String, String> sParaTemp,
		...
		sbHtml
				.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\"  enctype=\"multipart/form-data\" action=\""
						+ ALIPAY_GATEWAY_NEW
						+ "_input_charset="
						+ AlipayConfig.input_charset
						+ "\" method=\""
	 ...
	 */
	public static String query_timestamp(String partner, String input_charset)
