...
public class AlipayNotify {
     ...
     * @return 验证结果
     */
    public static boolean verify(Map<String, String> params,boolean isClient) {
...
//			responseTxt = verifyResponse(notify_id);
            responseTxt = verifyResponse(notify_id, AlipayConfig.partner);
        }
        String sign = "";
        if (params.get("sign") != null) {
            sign = params.get("sign");
        }
        boolean isSign = getSignVeryfy(params, sign,isClient);
        System.out.println("responseTxt==" + responseTxt + "----isSign==" + isSign);
...
//	    AlipayCore.logResult(sWord);
     ...
     * @return 生成的签名结果
     */
    private static boolean getSignVeryfy(Map<String, String> Params, String sign,boolean isClient) {
